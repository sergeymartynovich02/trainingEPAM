    ...
    class MainProgram
    {
        ...
        static void Main()
        {
            try { 
                ...
                int stlbca = Convert.ToInt32(Console.ReadLine());

                Console.WriteLine("Введите кол-во строк матрицы А: ");
                int nnb = Convert.ToInt32(Console.ReadLine());
                Console.WriteLine("Введите кол-во столбцов матрицы А: ");
                int stlbcb = Convert.ToInt32(Console.ReadLine());
                ...
                Matrix mass1 = new Matrix(nna, stlbca, nnb, stlbcb);
                Matrix mass2 = new Matrix(nna, stlbca, nnb, stlbcb);
                Matrix mass3 = new Matrix(nna, stlbca, nnb, stlbcb);
                Matrix mass4 = new Matrix(nna, stlbca, nnb, stlbcb);
                Matrix mass5 = new Matrix(nna, stlbca, nnb, stlbcb);
                Matrix mass6 = new Matrix(nna, stlbca, nnb, stlbcb);
